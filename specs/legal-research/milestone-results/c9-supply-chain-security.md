...
This result is not a clean bill of health for the whole upstream monorepo. Current full-root dependency scanning still reports findings in nonpackaged services and development dependencies. A release candidate still needs a signed-installer SBOM, provenance attestation, and a reviewed reachability/exclusion decision for broader findings.
