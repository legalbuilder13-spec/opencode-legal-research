...
Local verification passed for 940 desktop third-party package identities, 104 top-level Python distributions, managed CPython, three revision-locked Docling model repositories, and the four hash-locked RapidOCR files. Negative tests prove that missing license metadata, changed model weights, changed receipts, and stale overrides fail closed.
