...
| Live-web renderer/OCR corpus                      | Three-source macOS candidate passed; review pending | [`milestone-results/c4-live-web-renderer-corpus.md`](./milestone-results/c4-live-web-renderer-corpus.md)     |
| Parser resource and malformed-input hardening     | Local security gate passed                          | [`threat-model.md`](./threat-model.md)                                                                       |
| Worker memory/process containment                 | macOS packaged process gate passed; Linux memory/process CI-gated | [`milestone-results/c5-worker-resource-containment.md`](./milestone-results/c5-worker-resource-containment.md) |
